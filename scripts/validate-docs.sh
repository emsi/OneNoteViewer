...
reject_text 'Planning baseline established; implementation not started'
reject_text 'No application or library implementation has started.'
reject_text 'Milestone 1 feasibility work, ready to start'
