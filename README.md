...
1. [Download OneNote Viewer 0.3.0](https://github.com/emsi/OneNoteViewer/releases/latest/download/OneNoteViewer-0.3.0-linux-x86_64.flatpak).
...
```bash
flatpak install --user --or-update ./OneNoteViewer-0.3.0-linux-x86_64.flatpak
```
